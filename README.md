...
- Primeiros Passos com Python — Comando `print()`, variáveis básicas, entrada de dados com `input()`, tipos de dados, operadores aritméticos e ordem de precedência
- Tratando Dados e Fazendo Cálculos — Módulos e bibliotecas, módulo `math`, como variáveis são guardadas na memória, fatiamento de strings
